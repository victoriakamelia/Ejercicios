...
int menuTres()
{
    ...
    printf(" ,'   ,'             M E N U   D E   O P C I O N E S.            `.   `.\n");
    printf("(    (                                                             )    )\n");
    printf(" `.   `.                   1)MOSTRAR AUTOS COLOR NEGRO          .'   .' \n");
    printf("   )    )                  2)MOSTRAR AUTOS DE UNA MARCA.       (    (\n");
    printf(" ,'   ,' 3)MOSTRAR TODOS LOS TRABAJOS DE UN AUTO SELECCIONADO. `.   `.\n");
    printf("(    (               4)LISTAR AUTOS QUE NOTUVIERON TRABAJO.      )    )\n");
    printf(" `.   `.         5)IMPORTE TOTAL DE LOS TRABAJOS DE UN AUTO.   .'   .' \n");
    printf("   )    )                  6)SERVICIO MAS PEDIDO               (    (\n");
    printf(" ,'   ,'                   7)RECAUDACION FECHA PARTICULAR.     `.   `.\n");
    printf("(    (                     8)AUTO CON ENCERADO Y FECHA          )    )\n");
    printf(" `.   `.                   9)TRABAJO REALIZADO EN AUTO BLANCO .'   .' \n");
    printf("   )    )                  10)FACTURACION TOTAL POR PULIDO    (    (\n");
    printf("   )    )     11)MARCA DE AUTO QUE REALIZARON LAVADO COMPLETO  (    (\n");
    printf(" ,'   .' 12)AUTOS QUE RECIBIERON TRABAJO EN FECHA DETERMINADA   `.   `.\n");
    printf("(    '  _  `-'  _  `-'  _  `-'  _  `-'  _  `-'  _  `-'  _  `-'  _  `    )\n");
    printf("`.   .' `.   .' `.   .' `.   .' `.   .' `.   .' `.   .' `.   .' `.   .'\n");
    printf("  `-'     `-'     `-'     `-'     `-'     `-'     `-'     `-'     `-'\n");
    printf("->->->->->->->->->->->->->->->->-->->->-INGRESE OPCION SELECCIONADA: ");
